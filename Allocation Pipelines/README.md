This folder presents the following informations: 

Data Ingestion & Preprocessing (yfinance, pandas)
...
Risk Engine & Volatility Forecasting (arch)
...
Alpha Generation & Predictive Modeling (TensorFlow, XGBoost)
...
Portfolio Optimization (scipy, optuna)
